...
{!! Form::open(['route' => ['admin.user.update',$employee->nip], 'method' => 'POST','id' => 'user-form']) !!}
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                {!! Form::text('nip', $employee->nip, ['class' => 'form-control','maxlength' => '18']) !!}
              ...
              <div class="form-group">
                ...
                {!! Form::select('gender',['l' => 'Laki-Laki', 'p' => 'Perempuan'], $employee->gender, ['class' => 'form-control', 'placeholder' => 'Pilih Jenis Kelamin']) !!}
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Username <span class="red">*</span></label>
                  {!! Form::text('username', $employee->user->username, ['class' => 'form-control']) !!}
              ...
              {{-- <div class="form-group">
                <label>Password <span class="red">*</span></label>
                  {!! Form::text('password', $employee->user->password, ['class' => 'form-control']) !!}
